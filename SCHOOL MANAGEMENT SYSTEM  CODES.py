...
firstw=Tk()
firstw.title("GROUP 3 PROJECT PROPOSAL")
firstw.geometry("1600x1000+0+0")
label=Label(text="SIERRA INT.SCHOOL MANAGEMENT SYSTEM",font=("times new roman",35),bg="black",fg="white")
...
def second():
    global secondw
    secondw=Tk()
    secondw.title("GROUP 3 PROJECT PROPOSAL")
    ...
    def studentid():
        rot = Tk()
        rot.title("GROUP 3 PROJECT PROPOSAL")
    ...
    def viewenquiry2():
        rt = Tk()
        rt.title("GROUP 3 PROJECT PROPOSAL")
    ...
    def distroy5():
        secondw.destroy()
        window()
    mainlabel= Label(secondw,text="SIERRA INT. SCHOOL MANAGEMENT SYSTEM", font=("times new roman", 35), bg="black",fg="white")
    mainlabel.pack(side=TOP, fill=X)
...
def root():
    ...
    root.title("GROUP 3 PROJECT PROPOSAL")
    global entry1
    global entry2
    global entry3
    global entry4
...
#================================droplist======================================
    ...
    box['values']=['SELECT','SCIENCE DEPT','COMMERICIAL DEPT','ARTS DEPT','IT DEPT']
    box.current(0)
    box.place(x=503,y=395)

#===============================checkbutton====================================

    checkbutton1=Checkbutton(root,text="KONO",variable=java)
    checkbutton1.place(x=502,y=455 )

    checkbutton1=Checkbutton(root,text="BO",variable=c)
    checkbutton1.place(x=555,y=455 )

    checkbutton1=Checkbutton(root,text="KENEMA",variable=d)
    checkbutton1.place(x=600,y=455 ,)
	 
	 
    checkbutton1=Checkbutton(root,text="FREETOWN",variable=python)
